...
<div class="container" style="background-color: white; width: 60%;margin-top: 10px">
  ...
  <form action="formconnect.php" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
      <h3><label for="location">Which Location does your project belong to?</label></h3>
    ...
    <div class="form-group">
      ...
      <input type="number" class="form-control" id="days" placeholder="Deadline of your project" name="days">
    </div>
    <br>
...
<br>
    ...
    var fieldHTML = '<div class="form-group"><h3><label for="budget">Enter the budget of your project:</label></h3><input type="number" class="form-control" id="budget" placeholder="Budget in rupees" name="budget" required></div><br>';
    $(wrapper).empty();
