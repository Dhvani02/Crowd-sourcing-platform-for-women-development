...
// if everything is ok, try to upload file
  ...
  $query1="INSERT into project (user_id,project_title,project_short_description,project_description,project_image,project_category,project_location,project_website,project_funds,project_people,project_deadline,project_timestamp,project_photo) VALUES ('$userid','$_POST[title]','$_POST[shortdesc]','$_POST[desc]','$photo_name1','$cat','$location','$url','$budget','$worker','$days',(now()),'{$photo_name}')";
